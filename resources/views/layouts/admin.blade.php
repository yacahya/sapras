    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Pelaporan Sarpras</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <!-- <ul class="treeview-menu">
                    <li class="nav-item {{ Nav::isRoute('instansi') }}">
                        <a class="nav-link" href="{{ route('instansi') }}">
                            <i class="fas fa-fw fa-solid fa-building"></i>
                            <span>{{ __('Data Instansi') }}</span>
                        </a>
                    </li>

                    <li class="nav-item {{ url('laporan') }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Disdukcapil Garut {{ now()->year }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
